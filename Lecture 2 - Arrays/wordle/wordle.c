...
int main(int argc, string argv[])
{
    ...
    // TODO #2 : ensure argv[1] is either 5, 6, 7, or 8 and store that value in wordsize instead
        key= argv[1];
        if(strlen(key)!=1){
...
string get_guess(int wordsize){
    // TODO #3 : ensure users actually provide a guess that is the correct length 
    string guess;
    do {
